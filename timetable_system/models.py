...
def seed_data():
    ...
    cursor.execute("INSERT INTO departments (name, code) VALUES (?,?)", ('Engineering', 'ENG'))

    cursor.execute("INSERT INTO users (username, password, role, full_name, email, department_id) VALUES (?,?,?,?,?,?)",
    ...
    cursor.execute("INSERT INTO lecturer_preferences (user_id, preferred_days) VALUES (?,?)",
    ...
    cursor.execute("INSERT INTO courses (name, code, level, lecturer_id, group_name, duration_hours, department_id, color) VALUES (?,?,?,?,?,?,?,?)",
    ...
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (6, 1, 'Group A'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (6, 2, 'Group B'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (6, 4, 'Group B'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (7, 1, 'Group A'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (7, 2, 'Group B'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (7, 6, 'Group B'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (8, 7, 'Group C'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (8, 8, 'Group C'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (9, 7, 'Group C'))
    cursor.execute("INSERT INTO student_enrollments (student_id, course_id, group_name) VALUES (?,?,?)", (9, 8, 'Group C'))

    cursor.execute("INSERT INTO rooms (name, capacity, building, floor, room_type, has_projector, has_computers) VALUES (?,?,?,?,?,?,?)",
